...
class FrameBuffer {
    ...
    public:
        ...
        void UpdateSize(int width, int height) {
            ...
            this->Cleanup();
            this->Init(width_, height_, use_interpolation_, color_);
        }
        ...
        int Init(int image_width, int image_height, bool use_interpolation = false, GLint color = GL_R32F) {
            this->width_ = image_width;
            this->height_ = image_height;
            this->use_interpolation_ = use_interpolation;
            this->color_ = color;
            ...
            // create color attachment
            {
                ...
                glTexImage2D(GL_TEXTURE_2D, 0, color, width_, height_, 0,
                             GL_RED, GL_FLOAT, NULL);
                // FIXME : pourquoi pas GL_RED et GL_FLOAT ?? puisque GL_R32F
